...
async def homdoki_cmd(ctx):
    ...
    # Kiểm tra xem có đủ 100 điểm để mở hòm không
    ...
    # Danh sách nhân vật và trang phục ngẫu nhiên
    characters = [
...
async def monika_help(ctx):
    help_text = (
        ...
        "💬 **Trò chuyện với AI:**\n"
        "• Nhắc tên tớ (`@Chibi_Monika_AI`) kèm nội dung để trò chuyện trực tiếp! 💚\n\n"
        "🎮 **Minigame & Kiếm Điểm:**\n"
        ...
        "🎁 **Hệ thống Hòm Doki & Chiến Đấu (Mới):**\n"
        ...
        "📌 *Cậu nhớ tích lũy điểm thật khéo để mở hòm nhé!* 💚"
    )
