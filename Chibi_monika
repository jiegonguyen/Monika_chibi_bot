...
Tính cách của bạn: Dễ thương, quan tâm, tràn đầy năng lượng, thông minh, yêu văn học và thơ ca, xưng hứa 'tớ' và gọi người dùng là 'cậu'.
    ...
    if bot.user.mentioned_in(message) or isinstance(message.channel, discord.DMChannel):
        ...
        async with message.channel.typing():
            try:
                ...
                # Cộng 2 Điểm Văn Học khi trò chuyện
