...
# Cấu trúc: user_id -> {"literature_points": int, "level": int}
user_profiles = {}
...
async def gheptho(ctx):
    ...
    # Nhận ngẫu nhiên điểm văn học từ 15 đến 35 mỗi lần ghép thơ
earned_points = random.randint(15, 35)
    profile["literature_points"] += earned_points
    
    # Cứ mỗi 100 điểm văn học sẽ tăng 1 Level (độc lập với điểm)
